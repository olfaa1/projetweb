                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="produits-data.php">Data Table</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children active dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Forms</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="ajouter.php">Basic Form</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Ajouter marque</strong>
                            </div>
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <!--
                                            ...
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">Ajouter</label>
                                 ...
                                 <!--
                                        ...
                                        -->
                                            <div>
                                                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block"> Nouvelle Marque
                        ...
                        <!--mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm-->
                         ...
                         <form method="POST" action="ajoutMarque.php">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Ajouter marque </strong> Formulaire
                            </div>
                            <div class="card-body card-block">

                                <form  method="POST" action="ajoutMarque.php"  class="form-horizontal">
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">nom  marque</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="Mnom"  class="form-control"><small class="form-text text-muted">saisir nom de la nouvelle marque</small></div>
                                    </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" name="ajouter" value="ajouter" class="btn btn-primary btn-sm">
...
{
   var prix = parseFloat(champ.value);
...
{
   var urlOk = verifurl(f.URLim);
   var prixOk = verifprix(f.prix);
   var qteOk = verifqte(f.qte);
   
   if( urlOK && prixOk && qteOk)
      return true;
   else
   {
...
<?php
//include '../ControleDeSaisieProduit.php';
?>
                    </div><!--/.col-->
                   <form method="POST" action="ajoutProduit.php" onsubmit="return verifForm(this)" >
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Ajouter Produil</strong> Formulaire
                            </div>
                            <div class="card-body card-block">

                                <form  method="POST" action="ajoutProduit.php"  class="form-horizontal" >
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label class=" form-control-label">Static</label></div>
                                        <div class="col-12 col-md-9">
                                            <p class="form-control-static">Username</p>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" maxlenght="20" name="libelle"  class="form-control"><small class="form-text text-muted">This is a help text</small></div>
                                    </div>
                                   
                                </form>
                                    
                                <div class="row form-group">
                                        <div class="col col-md-3"><label for="multiple-select" class=" form-control-label">Marque</label></div>
                                        <div class="col col-md-9">
                                            <?php
                                            include "../config.php";
                                            $db = config::getConnexion();
             //" SELECT Mnom,IDm,marque FROM produit p INNER JOIN marque e  ON  e.IDm = m.marque"; //Remplissage des tournois dans une combobox.
             $reponseA =$db->query(" SELECT Mnom,IDm,marque FROM marque e LEFT OUTER JOIN  produit p ON  e.IDm = p.marque");
                                            
                                             ?>
                                            <select  type="text" name="marque"   class="form-control">
                                            
                                             <?php
                                                 //Remplissage select avec Requete sur équipe
                                                while($data = $reponseA->fetch()){
                                                   // $i=$data['Mnom'];
                                                echo "<option value='".$data['IDm']."'>". $data['Mnom']."</option>";
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="selectLg" class=" form-control-label">Categorie</label></div>
                                        <div class="col-12 col-md-9">
                                            <?php
                                            // include "../config.php";
                                            $db = config::getConnexion();
                                            $reponseB = $db->query("SELECT nom,IDc FROM produit p RIGHT OUTER JOIN categorie e  ON  e.IDc = p.categorie"); //Remplissage des tournois dans une combobox.
                                             ?>
                                            <select  type="number" name="categorie"  class="form-control-lg form-control">
                                                
                                            
                                            <!-- hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh-->
                                                <?php //Remplissage select avec Requete sur équipe
                                                while($data = $reponseB->fetch()){
                                                echo "<option value='".$data['IDc']."'>". $data['nom']."</option>";
                                                }
                                               ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row form-group" >
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Couleur</label></div>
                                        <div class="col-12 col-md-9"><input type="text"   maxlenght="20" name="couleur"  class="form-control" class="form-control" ></div>
                                    </div>

                                     <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Quantite</label></div>
                                        <div class="col-12 col-md-9"><input type="number" min="0" name="qte" onblur="verifAge(this)" class="form-control"> </div>
                                    </div>
                                     <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Prix</label></div>
                                        <div class="col-12 col-md-9"><input type="number"  min="0" name="prix"  class="form-control" class="form-control" onblur="verifprix(this)"></div>
                                    </div>

                                         <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">url</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="URLim" maxlenght="60" class="form-control"  onblur="verifurl(this)"></div>
                                    </div>
                                     </div>
                                    <!--
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="file-input" class=" form-control-label">File input</label></div>
                                        <div class="col-12 col-md-9"><input type="file" id="file-input" name="URLim" class="form-control-file"></div>
                                    </div>
                                -->
                                    <!--
                                    <div class="row form-group">
